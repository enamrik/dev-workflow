...
- **[MCP Tools Reference](/reference/mcp-tools)** - Explore all 55 available tools
- **[Task Execution Guide](/user-guide/task-execution)** - Learn about execution modes
- **[GitHub Integration](/user-guide/github-integration)** - Set up two-way sync
- **[Configuration Guide](/reference/configuration)** - Customize templates and settings

## Tips

:::tip Use Natural Language
Claude understands intent; you don't need exact commands. Just describe what you want to do.
:::

:::tip Check the Work Queue
Say "show work queue" to see prioritized tasks across all your issues.
:::

:::tip Isolated Mode is Default
Each task gets its own worktree for parallel work. Multiple tasks can be worked on simultaneously.
:::

:::tip Progress is Tracked
Resume tasks anytime with "continue task #X". Your progress is saved automatically.
:::

:::tip Enable GitHub Sync
Get automatic issue/task sync with GitHub Projects for team collaboration.
:::
