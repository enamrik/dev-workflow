 ...
 * generated from the Zod schemas in schemas.ts.
 */
...
export const issueToolDefinitions = [
  ...
  createToolDefinition(
    ...
    schemas.ImportGitHubIssueSchema
  ),
];
...
export const planToolDefinitions = [
  createToolDefinition(
    ...
    schemas.GeneratePlanSchema
  ),
  createToolDefinition(
    "get_plan",
    "Get the active plan for an issue with tasks",
    schemas.GetPlanSchema
  ),
  createToolDefinition(
    "pause_issue",
  ...
  createToolDefinition(
    ...
    schemas.MoveIssueToReadySchema
  ),
  createToolDefinition(
    ...
    schemas.MoveIssueToBacklogSchema
  ),
  createToolDefinition(
    "sync_issue",
...
export const taskToolDefinitions = [
  ...
  createToolDefinition(
    ...
    schemas.ListAvailableTasksSchema
  ),
  createToolDefinition(
    "delete_task",
  ...
  createToolDefinition(
    ...
    schemas.CheckTaskConflictsSchema
  ),
];
...
export const dispatchToolDefinitions = [
  ...
  createToolDefinition(
    ...
    schemas.GetDispatchStatusSchema
  ),
  createToolDefinition(
    "end_worker_session",
