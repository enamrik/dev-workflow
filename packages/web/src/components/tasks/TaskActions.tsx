...
export function TaskActions({
  ...
  const hasGitHub = !!task.githubSync?.githubUrl;
  ...
  return (
    ...
    >
      ...
      {hasGitHub && task.githubSync?.githubUrl && (
        <GitHubLinkWithCopy
          href={task.githubSync.githubUrl}
          issueNumber={task.githubSync.githubIssueNumber!}
        />
      )}
