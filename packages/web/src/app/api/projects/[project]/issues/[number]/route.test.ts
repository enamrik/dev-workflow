...
describe("getIssueWithDetailsEndpoint", () => {
  it("returns issue with plan and tasks", async () => {
    ...
    const req = new Request("http://localhost/api/projects/my-project/issues/5", {
      method: "GET",
    });
  ...
  it("returns 404 when issue not found", async () => {
    ...
    const req = new Request("http://localhost/api/projects/my-project/issues/999", {
      method: "GET",
    });
  ...
  it("returns 400 for invalid issue number", async () => {
    ...
    const req = new Request("http://localhost/api/projects/my-project/issues/invalid", {
      method: "GET",
    });
