...
describe("getTaskDependenciesEndpoint", () => {
  it("returns task dependencies with issue numbers", async () => {
    ...
    const req = new Request("http://localhost/api/projects/my-project/tasks/task-1/dependencies", {
      method: "GET",
    });
  ...
  it("returns 404 when task not found", async () => {
    ...
    const req = new Request(
      "http://localhost/api/projects/my-project/tasks/not-found/dependencies",
      { method: "GET" }
    );
