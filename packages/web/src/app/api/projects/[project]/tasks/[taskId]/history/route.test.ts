...
describe("getTaskStatusHistoryEndpoint", () => {
  it("returns task status history", async () => {
    ...
    const req = new Request("http://localhost/api/projects/my-project/tasks/task-1/history", {
      method: "GET",
    });
  ...
  it("returns 404 when task not found", async () => {
    ...
    const req = new Request("http://localhost/api/projects/my-project/tasks/not-found/history", {
      method: "GET",
    });
