/**
 * ProjectManagementRegistry - Registry for ProjectManagementProvider factories
 *
 ...
 *
 * Usage:
 *   const registry = ProjectManagementRegistry.getInstance();
...
export class ProjectManagementRegistry extends Service<ProjectManagementRegistry>()(
   ...
   */
  static getInstance(): ProjectManagementRegistry {
    if (!ProjectManagementRegistry.instance) {
      ProjectManagementRegistry.instance = new ProjectManagementRegistry();
    }
    return ProjectManagementRegistry.instance;
  }
  ...
  static resetInstance(): void {
    ProjectManagementRegistry.instance = null;
  }
  ...
  createProvider(project: Project, deps: ProviderDependencies): ProjectManagementProvider {
    ...
    const providerId = getProviderId(project.syncConfig);
 ...
 *
 * Uses the singleton ProjectManagementRegistry instance.
 *
 * @param project - The project containing provider configuration
 * @param deps - Provider dependencies
 * @returns A configured provider instance
...
export function getProjectManagementProvider(
  ...
  return ProjectManagementRegistry.getInstance().createProvider(project, deps);
}
